/**
 * Created by Soumya (soumya@smarttersstudio.com) on 16/06/21 at 4:19 PM.
 */
        ...
        <>
            <div>
                <Dialog aria-labelledby="form-dialog-title" onClose={handleClose} open={openDialog}>
                    ...
                    <DialogActions>
                        <Button color="secondary" onClick={handleClose} style={{fontSize: '15px', fontWeight: '600', textTransform: 'none'}}>
                            {'Cancel'}
                        </Button>
                        <Button
                            color="secondary"
